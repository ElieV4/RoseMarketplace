        ...
        <div class="content">
            ...
            <?php
                ...
                if(isset($_GET['ajoutpaiement'])){
                    ...
                    echo '<button><a href="espace_client_entreprise.php?profil&ajoutpaiement">Ajouter une carte de débit ou de crédit</a></button><br>';
                }
                if(isset($_GET['ajoutiban'])){
                    include('include/ajouter_iban.php');
                } else {
                    echo '<button><a href="espace_client_entreprise.php?profil&ajoutiban">Ajouter un compte bancaire</a></button><br>';
                }
                } else {
                    echo 'Erreur dans la requête : ' . mysqli_error($con);
                }
